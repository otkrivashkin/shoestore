					...
					<div class="map">
					 ...
					 <div class="contact-grids">
							 <div class="col_1_of_bottom span_1_of_first1">
								    ...
								    <ul class="list3">
										<li>
											<img src="<c:url value="/resources/images/home.png"/>" alt="">
								...
								<div class="col_1_of_bottom span_1_of_first1">
									...
									<ul class="list3">
										<li>
											   <img src="<c:url value="/resources/images/phone.png"/>" alt="">
											<div class="extra-wrap">
												<p><span>Telephone:</span>+1 800 258 2598</p>
											</div>
												<img src="<c:url value="/resources/images/fax.png"/>" alt="">
											<div class="extra-wrap">
								...
								<div class="col_1_of_bottom span_1_of_first1">
								    ...
								    <ul class="list3">
										<li>
											<img src="<c:url value="/resources/images/email.png"/>" alt="">
											<div class="extra-wrap">
