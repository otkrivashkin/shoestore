			...
			<div class="product-details">
				...
				<div class="details-left">
					...
					<div class="details-left-info">
						...
						<p class="product-detail-info">${product.description} <strong>Rating is ${product.rating}</strong> </p>
						<a class="learn-more" href="#"><h3>MORE DETAILS</h3></a>
						<div class="product-more-details">
							<ul class="price-avl">
								<li class="price"><span>${product.price}</span><label>${product.price/3}</label></li>
       		...
       		<div class="similar-products">
       			...
       			<div class="similar-products-right">
       				...
       				<!--- start-rate---->
							...
							<link rel="stylesheet" href="<c:url value="/resources/css/jstarbox.css"/>" type="text/css" media="screen"="utf-8" />
							<script type="text/javascript">
								jQuery(function() {
